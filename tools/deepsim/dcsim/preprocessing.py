            ...
            for sub_root, sub_dirs, sub_files in list_sub_dirs:
                for datafile in sub_files:
                    if os.path.splitext(datafile)[1] != '.txt':
                        continue
                    print(os.path.join(sub_root, datafile))
...
def extract_src_file():
    file_dir = "/Users/yumengluo/IdeaProjects/test/data/hw1-0.0.1-SNAPSHOT/"
    list_dirs = os.walk(file_dir)
    fout = open("/Users/yumengluo/Desktop/claire/Columbia/6156/deepsim-master/dataset/hw1-0.0.1-SNAPSHOT.txt", 'w')
    for root, dirs, _ in list_dirs:
        for d in dirs:
...
file_dir = "/Users/yumengluo/IdeaProjects/test/data/hw1-0.0.1-SNAPSHOT/"
save_dir= "/Users/yumengluo/Desktop/claire/Columbia/6156/deepsim-master/dataset/"
store(file_dir, save_dir)
